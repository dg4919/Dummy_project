...
(function () {
    ...
    configFn.$inject = ['$urlMatcherFactoryProvider', '$locationProvider', '$validatorProvider', 'blockUIConfig', 'localStorageServiceProvider', 'myServiceProvider'];         // use 'Provider' as suffix to use our own provider
    function configFn($urlMatcherFactoryProvider, $locationProvider, $validatorProvider, blockUIConfig, localStorageServiceProvider, myService) {
    ...
    var runFn = function ($rsc, svc, localStorageService, $injector, $state, webUrl, globalConfig) {
        $rsc.imgBase = globalConfig.imgBase;        // globalConfig is a constant service
    ...
    .constant('globalConfig', {
      // apiEndPoint: "http://www.api.silverzonehome.com/api/",
        apiEndPoint: "http://localhost:62781/api/",
        version: {
            Site: 'Site',
            User: 'User',
            Admin: 'Admin',
    ...
    .value('webUrl', { module: '' })
    .run(['$rootScope', 'notificationService', 'localStorageService', '$injector', '$state', 'webUrl', 'globalConfig', runFn])
